...
{
    if (!_resultView) {
        self.resultView = [[LLSearchResultView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREENH_HEIGHT) dataSource:self.searchArray];
    }
    return _resultView;
}
...
//    UIView *searchTextField = searchTextField = [self.searchBar valueForKey:@"_searchTextField"];
    ...
    if (version.doubleValue >= 13.0) {
        ...
        UITextField *searchTextField = searchTextField = [self.searchBar valueForKey:@"_searchTextField"];
