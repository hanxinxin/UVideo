...
- (void)kj_changeFrame{
    ...
    self.bottomView.frame = CGRectMake(kIs_iPhoneX?kTopBarSafeHeight:10, self.height-self.operationViewHeight, self.width-(kTopBarSafeHeight*2), self.operationViewHeight);
