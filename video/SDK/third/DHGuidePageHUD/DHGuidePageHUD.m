...
//            }
            ...
            if (i == imageNameArray.count-1 && isHidden == NO) {
                ...
                UIButton *startButton = [[UIButton alloc]initWithFrame:CGRectMake(DDScreenW*0.35, DDScreenH*0.8, 200, DDScreenH*0.08)];
                startButton.center = CGPointMake(self.applicationWindow.center.x,DDScreenH*0.8 );
                [startButton setTitle: DqLocalizedString(@"start_experience") forState:UIControlStateNormal];
                [startButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
                [startButton.titleLabel setFont:[UIFont systemFontOfSize:15]];
...
- (instancetype)dh_initWithFrame:(CGRect)frame videoURL:(NSURL *)videoURL {
    if ([super initWithFrame:frame]) {
        ...
        [movieStartButton setTitle:DqLocalizedString(@"start_experience") forState:UIControlStateNormal];
